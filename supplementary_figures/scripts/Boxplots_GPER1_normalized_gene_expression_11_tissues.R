...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "GPER1", "Morph", "Tissue")]
norm_counts_t$Gene <- "GPER1"
...
# Define y-axis label
y_label <- expression(paste(italic("GPER1") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/GPER1_gene_expression_all_tissues_Norm.svg", plot = p, 
