...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "SRD5A2", "Morph", "Tissue")]
norm_counts_t$Gene <- "SRD5A2"
...
# Define y-axis label
y_label <- expression(paste(italic("SRD5A2") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/SRD5A2_gene_expression_all_tissues_Norm.svg", plot = p, 
