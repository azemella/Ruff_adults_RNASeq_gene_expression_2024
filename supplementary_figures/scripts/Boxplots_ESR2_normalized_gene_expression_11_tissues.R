...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "ESR2", "Morph", "Tissue")]
norm_counts_t$Gene <- "ESR2"
...
# Define y-axis label
y_label <- expression(paste(italic("ESR2") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/ESR2_gene_expression_all_tissues_Norm.svg", plot = p, 
