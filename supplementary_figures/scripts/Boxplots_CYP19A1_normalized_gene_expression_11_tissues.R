...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "LOC106889446", "Morph", "Tissue")]
norm_counts_t$Gene <- "LOC106889446"
...
# Define y-axis label
y_label <- expression(paste(italic("CYP19A1") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/CYP19A1_gene_expression_all_tissues_Norm.svg", plot = p, 
