...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "AR", "Morph", "Tissue")]
norm_counts_t$Gene <- "AR"
...
# Define y-axis label
y_label <- expression(paste(italic("AR") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/AR_gene_expression_all_tissues_Norm.svg", plot = p, 
