...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "SRD5A1", "Morph", "Tissue")]
norm_counts_t$Gene <- "SRD5A1"
...
# Define y-axis label
y_label <- expression(paste(italic("SRD5A1") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/SRD5A1_gene_expression_all_tissues_Norm.svg", plot = p, 
