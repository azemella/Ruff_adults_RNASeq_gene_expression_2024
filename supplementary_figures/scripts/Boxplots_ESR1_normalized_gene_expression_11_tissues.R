...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "ESR1", "Morph", "Tissue")]
norm_counts_t$Gene <- "ESR1"
...
# Define y-axis label
y_label <- expression(paste(italic("ESR1") ~ "normalized gene expression"))
...
ggsave(filename = "supplementary_figures/plots/ESR1_gene_expression_all_tissues_Norm.svg", plot = p, 
