...
# Set up SVG output
svg("main_figures/plots/karyoploteR_inversion_faeder_vs_satellite_zoom.svg", 
    width = 28, height = 14)
...
top.genes <- sign.genes[sign.genes$gene_id %in% c("TUBB3", "GINS2", "PLCG2", "LOC106888173", "HSD17B2")]
names(top.genes)[3] <- "PLCG2"
points.top <- 0.8
...
kpAddLabels(kp, labels = expression('Log'[2]*'FC Faeder vs. Satellite'), srt = 90, pos = 1, label.margin = 0.07, 
