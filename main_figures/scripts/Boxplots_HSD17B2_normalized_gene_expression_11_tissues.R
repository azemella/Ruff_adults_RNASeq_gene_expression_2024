...
norm_counts_t <- norm_counts_t[, c("Sample_ID", "HSD17B2", "Morph", "Tissue")]
norm_counts_t$Gene <- "HSD17B2"
...
# Define y-axis label
y_label <- expression(paste(italic("HSD17B2") ~ "normalized gene expression"))
...
p <- ggplot(data = norm_counts_t,
  ...
  geom_signif(data = dat,
              aes(y_position = c(NA, NA, 145, 145, 145, 145, 145, 145, NA, 145, NA), 
                  xmin = c(NA, NA, 0.65, 0.65, 0.65, 0.65, 0.65, 0.65, NA, 0.65, NA), 
                  xmax = c(NA, NA, 1.35, 1.35, 1.35, 1.35, 1.35, 1.35, NA, 1.35, NA),
                  annotations = c("", "", "***", "***", "***", "***", "***", "***", "", "*", "")), 
              tip_length = 0.01, 
              manual = T,
              vjust = 0.65,
              ...
              inherit.aes = TRUE) +
  geom_signif(data = dat,
              aes(y_position = c(NA, NA, NA, 137, NA, NA, NA, NA, NA, NA, NA), 
                  xmin = c(NA, NA, NA, 1, NA, NA, NA, NA, NA, NA, NA), 
                  xmax = c(NA, NA, NA, 1.35, NA, NA, NA, NA, NA, NA, NA),
                  annotations = c("", "", "", "***", "", "", "", "", "", "", "")), 
              tip_length = 0.01, 
              manual = T,
              vjust = 0.65,
              ...
              inherit.aes = TRUE) +
  geom_signif(data = dat,
              aes(y_position = c(NA, NA, NA, 129, 137, 137, 137, 137, NA, NA, NA), 
                  xmin = c(NA, NA, NA, 0.65, 0.65, 0.65, 0.65, 0.65, NA, NA, NA), 
                  xmax = c(NA, NA, NA, 1, 1, 1, 1, 1, NA, NA, NA),
                  annotations = c("", "", "", "***", "***", "***", "***", "***", "", "", "")), 
              tip_length = 0.01, 
              manual = T,
              vjust = 0.65,
...
ggsave(filename = "main_figures/plots/HSD17B2_gene_expression_all_tissues.svg", plot = p, 
