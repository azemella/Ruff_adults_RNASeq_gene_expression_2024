...
write.csv(as.data.frame(full_res1), 
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/full_results/DGE_DESeq2_faeder_vs_independent_Phenotype_FR.csv", row.names = F)
write.csv(as.data.frame(full_res2),
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/full_results/DGE_DESeq2_satellite_vs_independent_Phenotype_FR.csv", row.names = F)
write.csv(as.data.frame(full_res3), 
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/full_results/DGE_DESeq2_faeder_vs_satellite_Phenotype_FR.csv", row.names = F)
...
write.csv(as.data.frame(sig_res1), 
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/significant_results/DGE_DESeq2_faeder_vs_independent_Phenotype_SR.csv", row.names = F)
write.csv(as.data.frame(sig_res2), 
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/significant_results/DGE_DESeq2_satellite_vs_independent_Phenotype_SR.csv", row.names = F)
write.csv(as.data.frame(sig_res3), 
          file = "DESeq2_gene_expression_analysis/DESeq2_results/phenotype/significant_results/DGE_DESeq2_faeder_vs_satellite_Phenotype_SR.csv", row.names = F)
