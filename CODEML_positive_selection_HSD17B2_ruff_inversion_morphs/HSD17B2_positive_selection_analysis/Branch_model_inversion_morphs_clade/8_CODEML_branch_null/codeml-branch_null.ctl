      seqfile = HSD17B2_mafft.phy            * Path to the alignment file
     treefile = HSD17B2_inversion_morphs_clade_contree.tree           * Path to the tree file
      outfile = out_HSD17B2_inversion_morphs_clade_branch_null.txt            * Path to the output file
